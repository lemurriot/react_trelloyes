...
class App extends React.Component {
  ...
  render(){
    const mapListsToStore = this.state.lists.map(list => <List key={list.id} header={list.header} onDeleteCard={ this.handleDeleteCard} onAddRandomCard={this.handleAddRandomCard} cardContent={list.cardIds.map(id => this.state.allCards[id])}/>);
    return (
      <main className="App">
